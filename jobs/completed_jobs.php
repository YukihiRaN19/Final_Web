    ...
    <div class="d-flex align-items-stretch gap-4">
        ...
        <main class="w-100">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2 text-dark"><i class="bi bi-check-circle-fill me-2"></i><?php echo $page_title; ?></h1>
            </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                if ($result && $result->num_rows > 0) {
                                    ...
                                    echo "<tr><td colspan='5' class='text-center text-muted py-3'>ไม่พบข้อมูลงานที่เสร็จแล้ว</td></tr>";
                                }
                                $conn->close();
                                ?>
                            </tbody>
            ...
            <div class="text-start mt-3">
                <a href="<?php echo BASE_URL; ?>main.php" class="btn btn-secondary"><i class="bi bi-arrow-left-circle-fill me-2"></i>กลับไปหน้ารวม</a>
            </div>
